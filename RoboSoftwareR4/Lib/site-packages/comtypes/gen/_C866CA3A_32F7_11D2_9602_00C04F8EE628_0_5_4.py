...
__all__ = [
    'ISpStream', 'SPWAVEFORMATTYPE', 'SpPhraseInfoBuilder',
    'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCVoice', 'SP_VISEME_19', 'SpeechRecoContextState',
    'SPEI_WORD_BOUNDARY', 'UINT_PTR', 'SP_VISEME_13',
    'eLEXTYPE_PRIVATE15', 'SRTStandard', 'ISpeechPhraseRule',
    'DISPID_SLPType', 'DISPID_SRSNumberOfActiveRules',
    'eLEXTYPE_PRIVATE17', 'DISPID_SPPEngineConfidence',
    'eLEXTYPE_PRIVATE1', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRGDictationSetState', 'SRERecognition', 'SPWORDTYPE',
    'SVSFIsNotXML', 'DISPID_SRCERequestUI',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechRecognizer',
    'SpeechRecognizerState', 'SDTLexicalForm',
    'DISPID_SpeechGrammarRuleStateTransition', 'SWTAdded',
    'DISPID_SCSBaseStream', 'SVPAlert', 'SpeechAllElements',
    'SPSHT_Unknown', 'SRERecoOtherContext', 'SP_VISEME_16',
    'SpeechDataKeyLocation', 'SpeechGrammarTagWildcard',
    'SVSFNLPSpeakPunc', 'DISPID_SRRAlternates', 'SPPS_Interjection',
    'DISPID_SBSRead', 'SPPHRASE', 'DISPID_SAFGuid',
    'DISPID_SpeechPhraseElement', 'DISPID_SRCreateRecoContext',
    'DISPID_SRGetFormat', 'SpStream', 'ISpeechPhraseAlternates',
    'SAFT44kHz8BitStereo', 'SpAudioFormat', 'DISPID_SGRSTNextState',
    'SVEViseme', 'DISPID_SpeechPhraseReplacement',
    'eLEXTYPE_PRIVATE18', 'DISPID_SpeechAudioStatus',
    'DISPID_SABIEventBias', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPAO_RETAIN_AUDIO', 'ISpeechPhraseProperty', 'SAFT8kHz16BitMono',
    'ISpeechPhraseReplacements', 'SRAExport',
    'DISPID_SVGetAudioInputs', 'SpeechPropertyAdaptationOn',
    'ISpeechRecoResult2', 'SPPS_SuppressWord',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRCEventInterests',
    'SpStreamFormatConverter', 'SAFT22kHz8BitMono', 'SPRST_ACTIVE',
    'SVEEndInputStream', 'DISPID_SRRSaveToMemory',
    'SPFM_OPEN_READWRITE', 'SPVISEMES', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPRuleParent',
    'SAFT12kHz16BitStereo', 'DISPID_SPEPronunciation',
    'SPEI_SOUND_START', 'DISPID_SVVolume', 'DISPID_SRState',
    ...
    'SPBO_PAUSE', 'DISPID_SVSLastBookmark', 'SPEI_SR_AUDIO_LEVEL',
    'SP_VISEME_14', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRCEAudioLevel', 'DISPID_SGRsCount',
    'DISPID_SOTGetStorageFileName', 'DISPID_SABIMinNotification',
    'DISPID_SLWs_NewEnum', 'SREFalseRecognition', 'SP_VISEME_21',
    'SPEI_VOICE_CHANGE', 'SAFTADPCM_11kHzMono', 'SP_VISEME_12',
    'DISPID_SRRecognizer', 'SPSHT_EMAIL', 'SP_VISEME_4',
    'SPEI_RESERVED2', 'DISPID_SVESentenceBoundary',
    'ISpeechVoiceStatus', 'ISpRecognizer', 'SVP_10',
    'SPEI_HYPOTHESIS', 'SPSMF_SRGS_SAPIPROPERTIES', 'SP_VISEME_8',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVSVisemeId',
    'DISPID_SGRSTsItem', 'SpeechEmulationCompareFlags',
    'SPAUDIOBUFFERINFO', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SDKGetlongValue', 'SpObjectTokenCategory',
    'DISPID_SGRSTType', 'ISpRecoCategory', 'DISPID_SGRAttributes',
    'ISpEventSource', 'SAFT32kHz16BitStereo',
    'DISPID_SRGCmdLoadFromFile', 'SPSNoun', 'SPEI_END_SR_STREAM',
    'DISPID_SLWsCount', 'DISPID_SLGetPronunciations',
    'ISpPhoneConverter', 'SPGS_EXCLUSIVE', 'SECFNoSpecialChars',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRRTimes',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechPhoneConverter',
    'SPBO_TIME_UNITS', 'SpeechMicTraining', 'SPCT_SLEEP',
    'ISpRecoContext', 'DISPID_SAStatus', 'Speech_Max_Pron_Length',
    'DISPID_SpeechPhraseElements', 'SRESoundEnd',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPDKL_LocalMachine',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SOTsCount',
    'ISpeechRecoResultDispatch', 'DISPID_SLWsItem', 'ISpNotifySink',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SGRInitialState',
    'SVEPrivate', 'ISpeechPhraseElements', 'SDTReplacement',
    'SPPS_Verb', 'SVP_7', 'DISPID_SPACommit', 'SDKLCurrentUser',
    'ISpeechTextSelectionInformation', 'SpNullPhoneConverter',
    'SPWT_PRONUNCIATION', 'SPDKL_CurrentConfig', 'DISPID_SLWLangId',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechRecognizerStatus',
    'SRERequestUI', 'DISPID_SRRSetTextFeedback', 'SASStop',
    'DISPID_SpeechObjectToken', 'eLEXTYPE_RESERVED6',
    'DISPID_SVEAudioLevel', 'DISPID_SABIBufferSize',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRCEStartStream',
    'SVSFPurgeBeforeSpeak', 'SVF_None', 'DISPID_SWFEExtraData',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechXMLRecoResult',
    'SVP_4', 'eLEXTYPE_USER', 'SPWORDPRONUNCIATIONLIST',
    'SPINTERFERENCE_NOISE', 'SVSFParseSsml', 'eLEXTYPE_RESERVED9',
    'SPPHRASERULE', 'ISequentialStream',
    ...
    'DISPID_SPPId', 'SPAS_CLOSED', 'DISPID_SRCEInterference',
    'SVP_14', 'DISPID_SVVoice', 'ISpSerializeState', 'SBOPause',
    'DISPID_SOTCategory', 'SSFMCreateForWrite',
    'DISPID_SRGSetTextSelection', 'SECFIgnoreWidth', 'SPVPRIORITY',
    'SpUnCompressedLexicon', 'SECFIgnoreKanaType', 'DISPID_SPRsItem',
    'STSF_CommonAppData', 'SAFT24kHz16BitMono', 'SPAS_PAUSE',
    'DISPID_SPIGrammarId', 'SPSModifier', 'SECNormalConfidence',
    'SVF_Stressed', 'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SFSOpen',
    'DISPID_SRSAudioStatus', 'DISPID_SLPPhoneIds',
    'SpPhoneticAlphabetConverter', 'DISPID_SRGRecoContext',
    'ISpRecoResult', 'SPEI_PHONEME', 'SpCompressedLexicon', 'SVP_0',
    'DISPID_SDKEnumKeys', 'DISPID_SPEActualConfidence',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechRecoContext',
    'SVP_12', 'SPRECORESULTTIMES', 'SPPS_Noun', 'SPCATEGORYTYPE',
    'DISPID_SPRText', 'SP_VISEME_11', 'DISPID_SRCEEnginePrivate',
    'SRSActiveAlways', 'DISPID_SpeechPhraseAlternate', 'SGRSTTRule',
    'SGDSActiveWithAutoPause', 'STCInprocHandler',
    'DISPID_SpeechAudio', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SVSpeakCompleteEvent', 'SPVOICESTATUS', 'ISpMMSysAudio',
    'SPDKL_CurrentUser', 'DISPID_SLAddPronunciationByPhoneIds',
    'SDTAlternates', 'SVP_16', 'DISPID_SDKEnumValues', 'SECFDefault',
    'SGDSActive', 'ISpeechMMSysAudio', 'DISPID_SpeechVoiceEvent',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechAudio',
    'DISPID_SLWType', 'DISPID_SRProfile', 'DISPID_SpeechLexiconWord',
    'SVEAudioLevel', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpMMAudioEnum', 'DISPID_SRCEEndStream', 'DISPID_SGRsDynamic',
    'DISPID_SPIGetDisplayAttributes', 'SECHighConfidence',
    'SpeechRuleAttributes', 'SpeechPartOfSpeech', 'SP_VISEME_9',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVAlertBoundary',
    'DISPID_SAVolume', 'SpeechCategoryRecognizers', 'DISPID_SGRName',
    'SAFT22kHz8BitStereo', 'DISPID_SRCESoundEnd', 'ISpeechRecognizer',
    'SITooLoud', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SPPConfidence',
    'DISPIDSPTSI_ActiveLength', 'SPBINARYGRAMMAR', 'ISpeechLexicon',
    'eLEXTYPE_PRIVATE2', 'ISpStreamFormatConverter', 'SRSEDone',
    'DISPID_SPPFirstElement', 'SAFT12kHz8BitMono', 'SPWT_DISPLAY',
    'DISPID_SRGetRecognizers', 'ISpeechVoice', 'STSF_AppData',
    '_ISpeechRecoContextEvents', 'SAFT48kHz16BitStereo',
    'DISPID_SVEStreamStart', 'SPLOADOPTIONS', 'DISPID_SRAudioInput',
    'ISpPhoneticAlphabetConverter', 'SDKLLocalMachine',
    'SPPARTOFSPEECH', 'ISpeechFileStream', 'DISPID_SRCERecognition',
    'ISpeechMemoryStream', 'SVEWordBoundary', 'SGRSTTWildcard',
    'SPEI_TTS_PRIVATE', 'SPEI_MIN_SR', 'SVSFPersistXML',
    'SPLEXICONTYPE', 'DISPID_SFSClose', 'DISPID_SpeechBaseStream',
    'tagSTATSTG', 'SECFIgnoreCase', 'SPCS_DISABLED', 'SPPS_RESERVED1',
    'SITooQuiet', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPFILEMODE', 'SAFTCCITT_uLaw_8kHzMono', 'Speech_StreamPos_Asap',
    'DISPID_SVAudioOutputStream', 'SPRST_ACTIVE_ALWAYS',
    'ISpPhoneticAlphabetSelection', 'SPEI_RESERVED3', 'SVP_5',
    'SRSActive', 'SpMMAudioOut', 'DISPID_SPIReplacements',
    'DISPID_SOTDataKey', 'DISPID_SpeechMemoryStream',
    'DISPID_SPEDisplayText', 'DISPID_SRRTTickCount',
    'SPBOOKMARKOPTIONS', 'DISPID_SDKDeleteValue',
    'SAFT24kHz16BitStereo', 'SpeechTokenKeyUI',
    'DISPID_SRGIsPronounceable', 'SPEI_PROPERTY_NUM_CHANGE',
    'SDA_No_Trailing_Space', 'SRSInactiveWithPurge',
    'DISPID_SPIGetText', 'SAFT16kHz8BitMono',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTCId', 'SP_VISEME_7',
    'SVSFUnusedFlags', 'SpNotifyTranslator', 'SAFTADPCM_44kHzStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SREPropertyStringChange',
    'SP_VISEME_6', 'DISPID_SRRGetXMLResult', 'SPSTREAMFORMATTYPE',
    'ISpeechRecoContext', 'DISPID_SPIStartTime',
    'DISPID_SVEStreamEnd', 'DISPID_SVEVoiceChange',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRCEAdaptation',
    'SPRECOSTATE', 'DISPID_SVPriority', 'SpeechEngineProperties',
    'SPGRAMMARWORDTYPE', 'DISPID_SPRuleId', 'DISPID_SPRules_NewEnum',
    'SECLowConfidence', 'SVP_15', 'STCRemoteServer',
    'SAFT32kHz16BitMono', 'SREAudioLevel', 'SAFTGSM610_44kHzMono',
    'SpSharedRecognizer', 'SPEI_END_INPUT_STREAM', 'SPCS_ENABLED',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRCRetainedAudioFormat',
    'SpeechAudioFormatType', 'DISPID_SRRDiscardResultInfo',
    'ISpeechLexiconWords', 'SAFT48kHz16BitMono',
    'SpeechGrammarTagUnlimitedDictation', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SASetState', 'SPSInterjection', 'SPEI_START_INPUT_STREAM',
    'ISpResourceManager', 'ISpeechResourceLoader',
    'ISpeechLexiconPronunciations', 'ISpVoice', 'SFTSREngine',
    'ISpeechPhraseAlternate', 'SPPS_LMA', 'DISPID_SOTCDefault',
    'SSTTDictation', 'DISPID_SPRuleFirstElement',
    'ISpeechPhraseProperties', 'SPPS_Function',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRCCreateGrammar',
    'DISPIDSPTSI', 'DISPID_SGRSTPropertyId',
    'DISPID_SOTCreateInstance', 'SAFT11kHz8BitMono',
    'eLEXTYPE_PRIVATE3', 'eLEXTYPE_PRIVATE8', 'SpeechLexiconType',
    'SpeechPropertyResponseSpeed', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SpeechVoice', 'SVSFParseMask', 'SpeechCategoryAudioIn',
    'SRESoundStart', 'DISPID_SpeechPhraseRules', 'SRAInterpreter',
    'DISPID_SpeechLexiconWords', 'DISPID_SRSCurrentStreamPosition',
    'SpLexicon', 'SDKLCurrentConfig', 'DISPID_SRCSetAdaptationData',
    'DISPID_SVEPhoneme', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SpeechRecoResult', 'SpeechCategoryVoices',
    'ISpeechPhraseReplacement', 'DISPID_SABufferNotifySize',
    'DISPID_SRGRules', 'SAFTDefault', 'SRAONone',
    'SpeechCategoryAudioOut', 'DISPID_SpeechAudioFormat',
    'SPEI_VISEME', 'SAFTText', 'SPCT_SUB_DICTATION',
    'SGRSTTDictation', 'SPSVerb', 'SPSHORTCUTPAIR',
    'SpeechTokenKeyAttributes', 'DISPID_SLPLangId',
    'SPEI_SENTENCE_BOUNDARY', 'SRAORetainAudio',
    'DISPID_SVIsUISupported', 'DISPID_SGRSTText',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPRsCount',
    'eLEXTYPE_PRIVATE6', 'SGLexicalNoSpecialChars',
    'DISPID_SPRFirstElement', 'DISPID_SVEBookmark',
    'eLEXTYPE_PRIVATE14', 'SAFT8kHz16BitStereo', 'SPSMF_UPS',
    'DISPID_SLPsItem', 'DISPID_SpeechGrammarRule', 'SVEBookmark',
    'DISPID_SRAudioInputStream', 'SVSFIsXML',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRCRecognizer',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SSTTTextBuffer',
    'SPSHORTCUTPAIRLIST', 'SVP_17', 'DISPID_SPAsCount',
    'SDTDisplayText', 'DISPID_SOTs_NewEnum', 'SRSInactive', 'SLTApp',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRSCurrentStreamNumber',
    'SPSERIALIZEDRESULT', 'SpeechCategoryRecoProfiles', 'SDTAudio',
    'DISPID_SRCPause', 'SPFM_CREATE', 'DISPID_SGRsCommit',
    'DISPID_SRRSpeakAudio', 'DISPID_SASCurrentSeekPosition',
    'SPWT_LEXICAL', 'SFTInput', 'ISpeechObjectToken',
    'DISPID_SPEsItem', 'SAFT16kHz16BitMono', 'DISPID_SRStatus',
    'IStream', 'DISPID_SGRSAddRuleTransition', 'SWTDeleted',
    'SPGRAMMARSTATE', 'DISPID_SMSGetData', 'DISPID_SPRuleName',
    'SPEI_MAX_TTS', 'DISPID_SASNonBlockingIO', 'SINone',
    'SP_VISEME_17', 'ISpDataKey', 'DISPID_SVSInputSentenceLength',
    'SPEI_RECOGNITION', 'DISPID_SRRAudioFormat',
    'SREPropertyNumChange', 'SPEI_REQUEST_UI', 'IEnumString',
    'SP_VISEME_15', 'STSF_FlagCreate', 'ISpLexicon', 'SVPNormal',
    'SREInterference', 'DISPID_SOTSetId',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechDataKey',
    'DISPID_SPRulesCount', 'DISPID_SVRate', 'DISPID_SRCResume',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SLPsCount',
    'WAVEFORMATEX', 'SPGS_DISABLED', 'DISPID_SGRsFindRule',
    'DISPID_SGRSTRule', 'Speech_StreamPos_RealTime',
    'eLEXTYPE_PRIVATE5', 'SPWORDPRONOUNCEABLE', 'SPCT_COMMAND',
    'SVP_18', 'SpeechWordPronounceable', 'DISPID_SOTDisplayUI',
    'SAFT32kHz8BitStereo', 'DISPID_SVWaitUntilDone',
    'DISPID_SPPsItem', 'SPWF_SRENGINE', 'DISPID_SVSpeak',
    'ISpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE19',
    'DISPID_SpeechMMSysAudio', 'SPPS_RESERVED4',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SPPParent', 'SDTAll',
    'SDKLDefaultLocation', 'DISPID_SVEventInterests',
    'ISpeechPhraseInfo', 'ISpNotifySource', 'DISPID_SPARecoResult',
    'SAFT11kHz16BitMono', 'ISpRecoGrammar2',
    'DISPID_SWFEAvgBytesPerSec', 'SPEI_ADAPTATION',
    'DISPID_SGRSTWeight', 'SAFT11kHz16BitStereo', 'SPAR_High',
    'SAFTADPCM_22kHzStereo', 'DISPID_SLPSymbolic',
    'SpeechCategoryAppLexicons', 'SpeechDiscardType',
    'DISPID_SRCAudioInInterferenceStatus', 'SpShortcut',
    'SPEI_RESERVED6', 'DISPID_SMSAMMHandle', 'SPAR_Medium',
    'SpeechVoicePriority', 'SpInProcRecoContext',
    'DISPID_SDKSetStringValue', 'SAFT12kHz16BitMono',
    'eLEXTYPE_RESERVED4', 'DISPID_SRCESoundStart', 'SPRST_INACTIVE',
    'Speech_Default_Weight', 'SpeechVoiceSpeakFlags',
    'SpeechAudioFormatGUIDText', 'tagSPPROPERTYINFO',
    'eLEXTYPE_RESERVED10', 'SP_VISEME_0', 'DISPID_SRGDictationLoad',
    'SAFT44kHz16BitMono', 'DISPID_SBSFormat', 'SPEI_MAX_SR',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SVSkip',
    'SREStreamEnd', 'SPVPRI_OVER', 'SPEI_RESERVED1',
    'SAFTADPCM_8kHzMono', 'SREBookmark', 'SpSharedRecoContext',
    'DISPID_SGRSTPropertyValue', 'DISPIDSPTSI_ActiveOffset',
    'SpeechVoiceEvents', 'SDTProperty', 'SPRECOCONTEXTSTATUS',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpPhrase',
    'DISPID_SpeechObjectTokenCategory', 'SPEI_RESERVED5',
    'SPFM_NUM_MODES', 'SAFTCCITT_uLaw_8kHzStereo', 'SREAdaptation',
    'SRATopLevel', 'SRAImport', 'SpeechAudioProperties', 'SVP_3',
    'SPSHT_OTHER', 'DISPID_SVGetVoices', 'SPRULE',
    'DISPID_SRGetPropertyNumber', 'SPEI_RECO_STATE_CHANGE',
    'SDA_One_Trailing_Space', 'SPEI_MIN_TTS', 'SPRST_NUM_STATES',
    'DISPID_SpeechCustomStream', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SVGetProfiles', 'DISPID_SGRSTransitions',
    'SSSPTRelativeToEnd', 'ISpeechPhraseRules', 'SAFT48kHz8BitStereo',
    'ISpeechAudioStatus', 'SPAUDIOSTATUS', 'SpeechLoadOption',
    'SPEVENTSOURCEINFO', 'DISPID_SRRPhraseInfo', 'SSFMOpenReadWrite',
    'SpeechTokenShellFolder', 'eWORDTYPE_ADDED', 'SPRS_ACTIVE',
    'SREAllEvents', 'SPWORDLIST', 'SpeechRetainedAudioOptions',
    'SRTReSent', 'SGPronounciation', 'SPXMLRESULTOPTIONS',
    'DISPID_SPEsCount', 'SINoise', 'SpeechInterference',
    'SpWaveFormatEx', 'DISPID_SPRNumberOfElements',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SGLexical',
    'SP_VISEME_18', 'SPINTERFERENCE_TOOFAST', 'SVSFParseSapi',
    'SREPhraseStart', 'DISPID_SRRTLength', 'DISPID_SASState',
    'DISPID_SGRAddState', 'SPLO_DYNAMIC', 'DISPID_SVSRunningState',
    'ISpShortcut', 'ISpeechWaveFormatEx', 'DISPID_SpeechPhraseRule',
    'DISPID_SPCLangId', 'SPEI_INTERFERENCE', 'SVPOver',
    'SpeechGrammarState', 'DISPID_SpeechGrammarRuleState', 'SVP_20',
    'eLEXTYPE_RESERVED8', 'DISPID_SVSInputWordPosition',
    'SVESentenceBoundary', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPPValue', 'SWPUnknownWordUnpronounceable',
    'DISPID_SVEViseme', 'SPEI_TTS_BOOKMARK',
    'DISPID_SGRsCommitAndSave', 'DISPID_SAFSetWaveFormatEx',
    'ISpRecoGrammar', 'DISPID_SGRSAddSpecialTransition',
    'SAFT24kHz8BitMono', 'SPPS_RESERVED3', 'SpResourceManager',
    'DISPID_SPEEngineConfidence', 'DISPID_SPIRule',
    'eLEXTYPE_PRIVATE12', 'tagSPTEXTSELECTIONINFO',
    'SpTextSelectionInformation', 'DISPID_SPAPhraseInfo',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCEFalseRecognition', 'SAFT16kHz16BitStereo',
    'DISPID_SRSetPropertyString', 'DISPID_SPCPhoneToId',
    'SAFT22kHz16BitStereo', 'DISPID_SGRSAddWordTransition',
    'SLODynamic', 'SPADAPTATIONRELEVANCE', 'SGDSInactive',
    'SAFTNoAssignedFormat', 'DISPID_SPAs_NewEnum',
    'DISPID_SRSSupportedLanguages', 'DISPID_SWFEBlockAlign',
    'DISPID_SPILanguageId', 'eLEXTYPE_PRIVATE13',
    'IInternetSecurityMgrSite', 'SGSExclusive',
    'DISPID_SRGSetWordSequenceData', 'SWPUnknownWordPronounceable',
    'SpeechGrammarRuleStateTransitionType', 'SAFT8kHz8BitMono',
    'SPPS_NotOverriden', 'DISPID_SDKDeleteKey', 'SPBO_NONE',
    'DISPID_SpeechLexicon', 'DISPID_SRCCreateResultFromMemory',
    'ISpStreamFormat', 'DISPIDSPRG', 'SVEVoiceChange',
    'SWPKnownWordPronounceable', 'SPAS_RUN', 'DISPID_SOTsItem',
    'ISpRecognizer2', 'DISPID_SGRSTsCount', 'SITooSlow',
    'SDA_Two_Trailing_Spaces', 'SVSFlagsAsync', 'SPPHRASEELEMENT',
    'SDTPronunciation', 'SpeechRunState', 'ISpeechPhraseElement',
    'DISPID_SAFType', 'DISPID_SABufferInfo',
    'DISPID_SRGetPropertyString', 'SpeechTokenValueCLSID',
    'DISPID_SRGCommit', 'SRADynamic', 'ISpeechRecoResultTimes',
    'IEnumSpObjectTokens', 'SVSFParseAutodetect',
    'SpeechTokenContext', 'ISpAudio', 'SAFTCCITT_ALaw_11kHzMono',
    'ISpNotifyTranslator', 'SP_VISEME_20',
    'DISPID_SLGetGenerationChange', 'DISPID_SRSClsidEngine',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechRecoResult',
    'SSTTWildcard', '_RemotableHandle', 'SPAR_Unknown',
    'DISPID_SPPs_NewEnum', 'DISPID_SMSALineId', 'SpeechFormatType',
    'SAFTCCITT_ALaw_8kHzMono', 'SpFileStream', 'SVSFIsFilename',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechRecoEvents',
    'SVEStartInputStream', 'SPFM_CREATE_ALWAYS', 'ISpObjectToken',
    'DISPID_SMSADeviceId', 'DISPID_SRIsShared',
    'SPDKL_DefaultLocation', 'DISPID_SGRSRule', 'ISpeechRecoGrammar',
    'eLEXTYPE_PRIVATE7', 'DISPID_SLPPartOfSpeech', 'SPRULESTATE',
    'DISPID_SVDisplayUI', 'DISPID_SpeechFileStream',
    '__MIDL_IWinTypes_0009', 'SpeechRecognitionType',
    'DISPID_SVEWord', 'SRSEIsSpeaking', 'DISPID_SpeechLexiconProns',
    'SVP_8', 'DISPIDSPTSI_SelectionOffset', 'ISpeechDataKey',
    'ISpXMLRecoResult', 'STCAll', 'SpeechDisplayAttributes',
    'eLEXTYPE_PRIVATE11', 'SLTUser', 'DISPID_SGRSTPropertyName',
    'SAFTCCITT_ALaw_44kHzStereo', 'eLEXTYPE_APP', 'ISpPhraseAlt',
    'SPRECOGNIZERSTATUS', 'DISPID_SVResume', 'DISPID_SVSPhonemeId',
    'SREPrivate', 'DISPID_SRRRecoContext', 'ISpProperties',
    'eLEXTYPE_RESERVED7', 'SpMMAudioIn', 'SpMemoryStream',
    'DISPID_SDKCreateKey', 'SAFT44kHz8BitMono',
    'SPEI_START_SR_STREAM', 'SPCT_DICTATION', 'SP_VISEME_3',
    'SPSHT_NotOverriden', 'SPDATAKEYLOCATION', 'SREHypothesis',
    'DISPID_SLGenerationId', 'SPPS_Unknown', 'SPCONTEXTSTATE',
    'eLEXTYPE_VENDORLEXICON', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SVPause', 'SPEVENTENUM', 'SPPS_Noncontent',
    'SAFTGSM610_22kHzMono', 'DISPID_SPRuleChildren',
    'DISPID_SREmulateRecognition', 'DISPID_SRCRequestedUIType',
    'DISPID_SGRsItem', 'ISpeechGrammarRule', 'ISpeechAudioFormat',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVEAllEvents',
    'ISpeechLexiconPronunciation', 'SPPHRASEPROPERTY',
    'DISPID_SPPName', 'SP_VISEME_1', 'SRTEmulated', 'SPXRO_SML',
    'DISPID_SOTId', 'DISPID_SOTRemove', 'SpeechGrammarWordType',
    'SASClosed', 'SPFM_OPEN_READONLY', 'SpInprocRecognizer',
    'SpeechAudioState', 'SpeechAudioFormatGUIDWave', 'SPSHORTCUTTYPE',
    'SPEI_SR_PRIVATE', 'SP_VISEME_5', 'SRCS_Disabled',
    'DISPID_SRGDictationUnload', 'SVP_19', 'SpeechVisemeFeature',
    'ISpRecoContext2', 'SPAO_NONE', 'SECFEmulateResult',
    'DISPID_SLRemovePronunciation', 'SpeechStreamFileMode',
    'SREStreamStart', 'DISPID_SLPs_NewEnum', 'STCInprocServer',
    'DISPID_SDKSetLongValue', 'SpeechGrammarTagDictation',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpVoice',
    'DISPID_SVAudioOutput', 'DISPID_SpeechPhraseProperties',
    'SpeechPropertyNormalConfidenceThreshold', 'SVP_1',
    'SPSSuppressWord', 'SpeechUserTraining',
    'SpeechSpecialTransitionType', 'SAFTADPCM_22kHzMono',
    'DISPID_SAEventHandle', 'SPEI_FALSE_RECOGNITION',
    'SRADefaultToActive', 'DISPID_SPELexicalForm',
    'eWORDTYPE_DELETED', '_ISpeechVoiceEvents', 'DISPID_SPIElements',
    'DISPID_SPIAudioStreamPosition', 'SPAUDIOOPTIONS', 'SBONone',
    'DISPID_SOTGetAttribute', 'SVP_21', 'SRTExtendableParse',
    'SSFMCreate', 'DISPID_SPANumberOfElementsInResult',
    'Speech_Max_Word_Length', 'DISPID_SRIsUISupported',
    'DISPID_SGRId', 'SAFT48kHz8BitMono', 'DISPID_SpeechVoiceStatus',
    'DISPID_SGRsAdd', 'SPSUnknown', 'SpeechRuleState',
    'SpeechRegistryUserRoot', 'DISPID_SOTCGetDataKey',
    'SPSEMANTICERRORINFO', 'SAFTADPCM_8kHzStereo',
    'ISpeechCustomStream', 'SASPause', 'SAFT8kHz8BitStereo',
    'SGSEnabled', 'DISPID_SLAddPronunciation',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPIRetainedSizeBytes',
    'SpeechVoiceSkipTypeSentence', 'ISpObjectWithToken',
    'DISPID_SDKGetStringValue', 'SPVPRI_NORMAL', 'SP_VISEME_2',
    'SPEI_SR_BOOKMARK', 'SPLO_STATIC', 'SPRS_INACTIVE', 'SVP_13',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechDictationTopicSpelling',
    'SGRSTTTextBuffer', 'SAFT12kHz8BitStereo', 'SPSNotOverriden',
    'DISPID_SPRuleConfidence', 'DISPID_SLWWord',
    'SAFTGSM610_8kHzMono', 'DISPID_SRGId', 'DISPID_SDKOpenKey',
    'SDTRule', 'SAFTADPCM_44kHzMono', 'SPSLMA', 'DISPID_SGRClear',
    'SPWF_INPUT', 'SPSEMANTICFORMAT', 'SAFT32kHz8BitMono',
    'DISPID_SPAsItem', 'DISPID_SOTCSetId',
    'ISpeechObjectTokenCategory', 'ISpObjectTokenCategory',
    'STSF_LocalAppData', 'SINoSignal', 'DISPID_SVSLastResult',
    'DISPID_SDKGetBinaryValue', 'SVSFVoiceMask', 'SGSDisabled',
    ...
    'SAFTNonStandardFormat', 'SPVPRI_ALERT',
    'DISPID_SASFreeBufferSpace', 'SREStateChange',
    'ISpeechLexiconWord', 'DISPID_SRCEPhraseStart', 'DISPID_SRGReset',
    'DISPID_SBSSeek', 'eLEXTYPE_PRIVATE9', 'DISPID_SADefaultFormat',
    'SPTEXTSELECTIONINFO', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SOTGetDescription', 'DISPID_SDKSetBinaryValue',
    'SPAUDIOSTATE', 'SVP_11', 'SPINTERFERENCE', 'DISPID_SPRs_NewEnum',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPISaveToMemory',
    'eLEXTYPE_PRIVATE4', 'SGDSActiveUserDelimited', 'SGDisplay',
    'ISpGrammarBuilder', 'ISpeechAudioBufferInfo', 'DISPID_SRGState',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRCERecognizerStateChange',
    'SLOStatic', 'SpPhoneConverter', 'DISPID_SpeechPhraseBuilder',
    'ISpeechBaseStream', 'ISpeechGrammarRuleState',
    'DISPID_SPPNumberOfElements', 'DISPID_SRDisplayUI', 'SRARoot',
    ...
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SGRAddResource',
    ...
    'SPWORD', 'DISPID_SPEAudioSizeTime', 'DISPID_SPIProperties',
    'DISPID_SpeechGrammarRules', 'DISPID_SRCState',
    'SAFT24kHz8BitStereo', 'SpeechBookmarkOptions',
    'DISPID_SOTMatchesAttributes', 'SAFTExtendedAudioFormat',
    'SVF_Emphasis', 'DISPID_SVGetAudioOutputs', 'SVP_6',
    ...
    'SSSPTRelativeToStart', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPEI_SOUND_END', 'SVP_9', 'SRCS_Enabled', 'SSFMOpenForRead',
    'DISPID_SVEEnginePrivate', 'SPAR_Low', 'DISPID_SPIEngineId',
    'eLEXTYPE_PRIVATE16', 'SGRSTTWord', 'SpeechRecoProfileProperties',
    'DISPID_SPEDisplayAttributes', 'SPPS_RESERVED2',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpEventSink',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRRTStreamTime',
    ...
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SMSSetData',
    'SpeechStreamSeekPositionType', 'SAFTGSM610_11kHzMono',
    ...
    'SPSERIALIZEDPHRASE', 'SVP_2', 'SITooFast',
    'DISPID_SpeechAudioBufferInfo', 'SpeechCategoryPhoneConverters',
    'SAFT11kHz8BitStereo', 'DISPID_SPPsCount', 'SpeechAudioVolume',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SBSWrite',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SVSpeakStream',
    'DISPID_SRCRetainedAudio', 'SpObjectToken', 'SpeechVisemeType',
    'DISPID_SLWPronunciations', 'SRTAutopause', 'SPEI_PHRASE_START',
    'ISpRecognizer3', 'SPPROPERTYINFO', 'STCLocalServer',
    'ISpeechObjectTokens', 'SAFT44kHz16BitStereo', 'SASRun',
    'SAFT22kHz16BitMono', 'SpeechEngineConfidence', 'SP_VISEME_10',
    'SpCustomStream', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SVSInputWordLength', 'DISPID_SRCEBookmark', 'SPAS_STOP',
    'SGRSTTEpsilon', 'DISPID_SRGCmdSetRuleIdState', 'SPEI_UNDEFINED',
    'SPPS_Modifier', 'SPINTERFERENCE_TOOSLOW', 'SPINTERFERENCE_NONE',
    'SRTSMLTimeout', 'SPWORDPRONUNCIATION', 'SPBO_AHEAD',
    'SpeechTokenKeyFiles', 'DISPID_SLGetWords',
    'DISPID_SPERequiredConfidence', 'DISPID_SpeechObjectTokens',
    'DISPID_SVSLastBookmarkId', 'SPEVENT', 'SVEPhoneme',
    'DISPID_SPRDisplayAttributes', 'SpeechTokenIdUserLexicon',
    'DISPID_SRCBookmark', 'DISPID_SPPChildren', 'DISPID_SRRAudio',
    'SpeechWordType', 'SVSFNLPMask', 'SPSMF_SAPI_PROPERTIES'
]

_check_version('1.1.14', 1523489676.307134)
