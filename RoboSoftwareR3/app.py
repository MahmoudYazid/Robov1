...
from model.AnalysisFormApi import AnalysisPage
...
class GuiWidget(ttk.Labelframe):
    ...
    def __init__(self, master=None, **kw):
        ...
        self.AnalysisBtm = ttk.Button(self, command=AnalysisPage)
        self.AnalysisBtm.configure(state="normal", text='Analysis', width=20)
        self.AnalysisBtm.grid(column=0, padx=490, pady=10, row=10, sticky="sw")
